...
Please check [ESP-IDF docs](https://docs.espressif.com/projects/esp-idf/en/v5.5/esp32c5/get-started/index.html) for getting started instructions if you'd like to develop and have any difficulties.
