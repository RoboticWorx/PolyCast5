...
void lcd_lora_page(ui_btns_t *ui_btns, ui_menu_t *ui_menu, lora_menu_t *lora_menu) 
{
    ...
    if (ui_btns->up_btn == 1) {
        ...
        if (meshtastic_enabled) {
            ...
            // Drop an outcome latched before this plug's page opened; a command
            // still in flight is filtered by the page itself when it lands
...
void lcd_bluetooth_page(ui_btns_t *ui_btns, ui_menu_t *ui_menu, bluetooth_menu_t *bluetooth_menu)
{
    ...
    } else if (ui_btns->select_btn == 1 && bluetooth_menu->index == 8) { // BLE Flood selected
        // Hide bluetooth menu
        lv_obj_add_flag(bluetooth_menu->main_list, LV_OBJ_FLAG_HIDDEN);
    ...
    } else if (ui_btns->select_btn == 1 && bluetooth_menu->index == 10) { // Known devices selected
        // Hide bluetooth menu
        lv_obj_add_flag(bluetooth_menu->main_list, LV_OBJ_FLAG_HIDDEN);
