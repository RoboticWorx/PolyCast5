...
// Custom settings to draw from PSRAM
#define LV_MEM_CUSTOM            1
#define LV_MEM_CUSTOM_INCLUDE    "esp_heap_caps.h"
#define LV_MEM_CUSTOM_ALLOC(sz)  heap_caps_malloc((sz), MALLOC_CAP_SPIRAM | MALLOC_CAP_8BIT)
#define LV_MEM_CUSTOM_REALLOC(p, sz) \
	                             heap_caps_realloc((p), (sz), MALLOC_CAP_SPIRAM | MALLOC_CAP_8BIT)
#define LV_MEM_CUSTOM_FREE(p)    heap_caps_free(p)
	
/* Disable all of the old builtin‐pool macros so no TLSF code ever gets pulled in */
#undef  LV_MEM_SIZE
#define LV_MEM_SIZE             0
#undef  LV_MEM_POOL_EXPAND_SIZE
#define LV_MEM_POOL_EXPAND_SIZE 0
#undef  LV_MEM_ADR
#define LV_MEM_ADR              0
// End custom settings to draw from PSRAM
...
// Toggle: comment out to fall back to default font Montserrat across all sizes
// #define POLYCAST5_USE_BORN2BSPORTYFS_FONT 1

/*Montserrat fonts with ASCII range and some symbols using bpp = 4
 *https://fonts.google.com/specimen/Montserrat*/
#ifndef POLYCAST5_USE_BORN2BSPORTYFS_FONT
    ...
    /* Suppress Born2bSporty font bodies so they take zero flash */
    #define BORN2BSPORTYFS_12 0
    #define BORN2BSPORTYFS_14 0
    #define BORN2BSPORTYFS_16 0
    #define BORN2BSPORTYFS_18 0
    #define BORN2BSPORTYFS_20 0
    #define BORN2BSPORTYFS_22 0
    #define BORN2BSPORTYFS_24 0
    #define BORN2BSPORTYFS_30 0
#else // #ifdef POLYCAST5_USE_BORN2BSPORTYFS_FONT
    #define LV_FONT_MONTSERRAT_8  0
    #define LV_FONT_MONTSERRAT_10 0
    #define LV_FONT_MONTSERRAT_12 0
    #define LV_FONT_MONTSERRAT_14 1 // Fallback
